...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname championship-bracket-improved-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
  ...
  (cond [(false? br) false]
        [else
         (if (string=? t (bracket-team-lost br))
             (bracket-team-won br)
             (local [(define team-winner (ouster t (bracket-br-won br)))]
               (if (not (false? team-winner))
                   team-winner
